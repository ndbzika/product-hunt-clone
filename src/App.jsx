        ...
        <Box maxW={800} w='100%' h='100vh' py={10} px={2}>
          ...
          <Box overflowY='auto' height='100%'>
            <Table mt='6'>
              <Thead>
                <Tr>
                  <Th maxW={isMobile ? 5:100} fontSize='20px'>Nome do Produto</Th>
                  <Th maxW={isMobile ? 5:100} fontSize='20px'>Descrição do Produto</Th>
                  <Th p={0}></Th>
                  <Th p={0}></Th>
                </Tr>
              </Thead>
              <Tbody>
                {data.map(({name, detail}, index) => (
                  <Tr key={index} cursor='pointer' _hover={{bg: 'gray.100'}}>
                    ...
                    <Td maxW={isMobile ? 5:100}>{detail}</Td>
                    <Td p={0}>
                      <EditIcon fontSize={20} onClick={() => [
                        setDataEdit({name, detail, index}), onOpen(),
                      ]}
                    />
                    </Td>
                    <Td p={0}>
                      <DeleteIcon fontSize={20} onClick={() => handleRemove(name)}/>
                    </Td>
                  </Tr>
                ))}
              </Tbody>
